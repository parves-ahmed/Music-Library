...
<!--					<li class="fh5co-active"><a href="update.php">Upadate</a></li>-->
		...
		<div id="fh5co-main">
			...
			<div class="fh5co-narrow-content">
				<h2 class="fh5co-heading animate-box" data-animate-effect="fadeInLeft">Update Music</h2>
			...
			<div class="form-class col-md-8">
				<form class="form-horizontal">
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input  class="form-control" name="sdesc" placeholder="Small Description">
						</div>
					</div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select class="form-control">
                                <option value="0"><b>Non-Featured</b></option>
                                <option value="1"><b>Featured</b></option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="file" class="form-control" name="sdesc" placeholder="Small Description">
                        </div>
                    </div>
