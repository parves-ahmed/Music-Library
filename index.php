	...
	<div id="fh5co-page">
		...
		<div id="fh5co-main">
			...
			<div class="fh5co-narrow-content">
				<h2 class="fh5co-heading animate-box" data-animate-effect="fadeInLeft">Music is<div style="color:#da1212;">Life</div></h2>
...
<!--                -->
            ...
            <div class="col-md-12 feature-song">
                <div style="border-left: 6px solid #da1212;margin-left: 50px;margin-top: 30px;margin-botto: 20px;">
                    <h3>Rock</h3>
                </div>
                <?php
                $i=0;
                $getsong=$song->getRock();
                if ($getsong){
                    while ($result = $getsong->fetch_assoc()){
                        $i++;
                        if($i <= 4) {
